...
class Category {
  ...
  const Category({
    ...
    required this.color, required this.bgColor, required this.count,
  });
}

final List<Category> categories = [
  Category(id: 'medical', name: '의료시설', icon: '🏥', color: AppColors.medical, bgColor: const Color(0xFFFEF2F2), count: 89),
  Category(id: 'pharmacy', name: '약국', icon: '💊', color: AppColors.pharmacy, bgColor: const Color(0xFFFDF2F8), count: 134),
  Category(id: 'education', name: '교육시설', icon: '🏫', color: AppColors.education, bgColor: const Color(0xFFEFF6FF), count: 67),
  Category(id: 'childcare', name: '유아돌봄', icon: '👶', color: AppColors.childcare, bgColor: const Color(0xFFFFFBEB), count: 42),
  Category(id: 'welfare', name: '노인복지', icon: '🏛', color: AppColors.welfare, bgColor: const Color(0xFFECFDF5), count: 28),
  Category(id: 'food', name: '맛집', icon: '🍽', color: AppColors.food, bgColor: const Color(0xFFFFF7ED), count: 156),
  Category(id: 'culture', name: '문화시설', icon: '🎭', color: AppColors.culture, bgColor: const Color(0xFFF5F3FF), count: 45),
  Category(id: 'government', name: '공공기관', icon: '🏢', color: AppColors.government, bgColor: const Color(0xFFECFEFF), count: 31),
];
